...
if($is_searching){
    $search = "SELECT * FROM studentgeneraldata WHERE admission LIKE ? AND gamesstatus = 'uncleared' ";
...
$stmt = "SELECT COUNT(*) FROM studentgeneraldata WHERE gamesstatus='uncleared' ";
...
$sql = "SELECT * FROM studentgeneraldata WHERE gamesstatus='uncleared' LIMIT $offset, $result_per_page";
...
<head>
    ...
    <title>games department uncleared</title>
...
<body>
    <nav>
        <h2><span class="material-symbols-outlined">dashboard</span>uncleared games department</h2>
        <div class="links">
    ...
    <div class="searchoutput">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><?php echo "{$info['gamesitemslost']}"?></td>
            ...
            <?php 
                ...
                echo '<tr><td colspan="11">No student found matching the admission: ' . htmlspecialchars($input) .' who has uncleared games fees'. '</td></tr>';
            } else {
    ...
    <div class="details">
        <h2>students with uncleared games fees</h2>
        <table>
            <th>name</th>
            <th>admission</th>
            <th>year</th>

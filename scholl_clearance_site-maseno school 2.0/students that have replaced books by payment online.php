...
<head>
    ...
    <title>students that have paid for books lost online</title>
    <link rel="stylesheet" href="style.css">
     <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet" />
</head>
<body>
    <nav>
        <h2><span class="material-symbols-outlined">dashboard</span>online books payment data</h2>
        <div class="links">
    ...
    <div class="details">
        <h2>students that have paid for books lost online</h2>
        <table>
            <th>name</th>
            <th>admission</th>
            <th>year</th>

...
if($is_searching){
    $search = "SELECT * FROM payments WHERE admission LIKE ? AND dept= 'finance' ";
...
$stmt = "SELECT COUNT(*) FROM payments WHERE dept='finance' ";
...
$sql = "SELECT * FROM payments WHERE dept='finance' LIMIT $offset, $result_per_page";
...
<head>
    ...
    <title>finance department online payments</title>
...
<body>
    <nav>
        <h2><span class="material-symbols-outlined">dashboard</span>finance department online payments</h2>
        <div class="links">

...
if($is_searching){
    $search = "SELECT * FROM payments WHERE admission LIKE ? AND dept= 'boarding' ";
...
$stmt = "SELECT COUNT(*) FROM payments WHERE dept='boarding' ";
...
$sql = "SELECT * FROM payments WHERE dept='boarding' LIMIT $offset, $result_per_page";
...
<head>
    ...
    <title>boarding department online payments</title>
...
<body>
    <nav>
        <h2><span class="material-symbols-outlined">dashboard</span>boarding department online payments</h2>
        <div class="links">
    ...
    <div class="searchoutput">
        ...
        <table class="table">
            ...
            <th>date</th>
            <th>amount paid</th>
            <th>boarding payment message</th>
            <?php

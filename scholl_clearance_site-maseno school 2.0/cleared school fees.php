...
if($is_searching){
    $search = "SELECT * FROM studentgeneraldata WHERE admission LIKE ? AND feestatus = 'cleared' ";
...
$stmt = "SELECT COUNT(*) FROM studentgeneraldata WHERE feestatus='cleared' ";
...
$sql = "SELECT * FROM studentgeneraldata WHERE feestatus='cleared' LIMIT $offset, $result_per_page";
...
<body>
    <nav>
        <h2><span class="material-symbols-outlined">dashboard</span>cleared fees</h2>
        <div class="links">
    ...
    <div class="searchoutput">
        ...
        <table class="table">
            ...
            <?php 
                ...
                echo '<tr><td colspan="11">No student found matching the admission: ' . htmlspecialchars($input) . ' who has cleared school fees' .'</td></tr>';
            } else {
    ...
    <div class="details">
        <h2>students with cleared school fees</h2>
        <table>
            <th>name</th>
            <th>admission</th>
            <th>year</th>

...
if($is_searching){
    $search = "SELECT * FROM studentgeneraldata WHERE admission LIKE ? AND labstatus = 'cleared' ";
...
$stmt = "SELECT COUNT(*) FROM studentgeneraldata WHERE labstatus='cleared' ";
...
$sql = "SELECT * FROM studentgeneraldata WHERE labstatus='cleared' LIMIT $offset, $result_per_page";
...
<head>
    ...
    <title>lab department cleared</title>
...
<body>
    <nav>
        <h2><span class="material-symbols-outlined">dashboard</span>cleared lab department</h2>
        <div class="links">
    ...
    <div class="searchoutput">
        ...
        <table class="table">
            ...
            <?php 
                ...
                echo '<tr><td colspan="11">No student found matching the admission: ' . htmlspecialchars($input) .' who has cleared lab fees'. '</td></tr>';
            } else {
    ...
    <div class="details">
        <h2>students with cleared lab fees</h2>
        <table>
            <th>name</th>
            <th>admission</th>
            <th>year</th>

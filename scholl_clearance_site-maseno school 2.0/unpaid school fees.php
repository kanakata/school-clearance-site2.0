...
if($is_searching){
    $search = "SELECT * FROM studentgeneraldata WHERE admission LIKE ? AND feestatus = 'uncleared' ";
...
$stmt = "SELECT COUNT(*) FROM studentgeneraldata WHERE feestatus='uncleared' ";
...
$sql = "SELECT * FROM studentgeneraldata WHERE feestatus='uncleared' LIMIT $offset, $result_per_page";
...
<head>
    ...
    <title>fee department uncleared</title>
...
<body>
    <nav>
        <h2><span class="material-symbols-outlined">dashboard</span>uncleared fee department</h2>
        <div class="links">
    ...
    <div class="searchoutput">
        ...
        <table class="table">
            ...
            <?php 
                ...
                echo '<tr><td colspan="11">No student found matching the admission: ' . htmlspecialchars($input) .' who has uncleared fee fees'. '</td></tr>';
            } else {
    ...
    <div class="details">
        <h2>students with uncleared fee fees</h2>
        <table>
            <th>name</th>
            <th>admission</th>
            <th>year</th>

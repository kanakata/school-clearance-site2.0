...
if($is_searching){
    $search = "SELECT * FROM studentgeneraldata WHERE admission LIKE ? AND boardingstatus = 'uncleared' ";
...
//pagination
//COLLECTINg OF THE NUMBER OF STUDENTS WITH uncleared FEES
$result_per_page = 1;
$current_page = $_GET['page'] ?? 1;


$stmt = "SELECT COUNT(*) FROM studentgeneraldata WHERE boardingstatus='uncleared' ";
...
$sql = "SELECT * FROM studentgeneraldata WHERE boardingstatus='uncleared' LIMIT $offset, $result_per_page";
...
<head>
    ...
    <title>boarding department uncleared</title>
...
<body>
    <nav>
        <h2><span class="material-symbols-outlined">dashboard</span>uncleared boarding department</h2>
        <div class="links">
    ...
    <div class="searchoutput">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><?php echo "{$info['boardingitemsdamaged']}"?></td>
            ...
            <?php 
                ...
                echo '<tr><td colspan="11">No student found matching the admission: ' . htmlspecialchars($input) .' who has uncleared boarding fees'. '</td></tr>';
            } else {
    ...
    <div class="details">
        <h2>students with uncleared boarding fees</h2>
        <table>
            <th>name</th>
            <th>admission</th>
            <th>year</th>
